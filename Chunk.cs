...
public class Chunk : MonoBehaviour
{
    ...
    {
        //count = new ComputeBuffer(1, 4, ComputeBufferType.Counter);
        //vertexCounter = new ComputeBuffer(1, 4, ComputeBufferType.Counter);
        //indexCounter = new ComputeBuffer(1, 4, ComputeBufferType.Counter);
    ...
    void DrawMesh()
    {
        ...
        //vertexCounter.SetCounterValue(0);
        //indexCounter.SetCounterValue(0);
        //count.SetCounterValue(0);
        ...
        //chunkShader.SetBuffer(AddVoxelDataToChunk, "_count", count);
